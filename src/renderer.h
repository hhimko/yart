...
namespace yart
{
    ...
    public:
        ...
        /// @param buffer Pointer to a pixel array to be rendered onto. The size of the array should be equal width*height*3, where 3 denotes the number of channels in the output image (RGB)
