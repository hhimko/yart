...
// Shades of trinary 
#define YART_GUI_COLOR_DARK_TRINARY  0.02f, 0.72f, 0.55f
#define YART_GUI_COLOR_TRINARY       0.00f, 1.00f, 0.72f
#define YART_GUI_COLOR_LIGHT_TRINARY 0.00f, 1.00f, 0.72f
