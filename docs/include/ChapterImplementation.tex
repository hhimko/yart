...
The functionality of calculating the color at the closes intersection point is usually referred to as the \textit{closest hit shader}.
This shader is typically responsible for evaluating materials, calculating lighting, and generating shadows. 

At its core, the closest hit shader employed in the YART engine computes diffuse and specular illumination based on the Blinn-Phong shading model, described in section \ref{ch:Implementation/SceneRepresentation/Materials}.
...
\subsection{The Ray Tracing Loop}
